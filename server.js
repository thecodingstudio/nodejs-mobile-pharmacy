...
// Difine simple route.
app.get("/", (req, res) => {
    res.status(200).send('Welcome to Pharmacy-App APIs..');
});
...
Prescription.hasMany(Prescription_image, { constraints: true, onDelete: 'CASCADE' });
Prescription.hasMany(Medicine, { constraints: true, onDelete: 'CASCADE' });
